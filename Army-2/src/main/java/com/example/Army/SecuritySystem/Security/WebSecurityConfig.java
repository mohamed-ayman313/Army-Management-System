...
//    @Bean
    public String addTestUser(){
        Member yassin = new Member("yassin","ayman","654845316331","yassin","good", MemberDegree.ROLE_SOLDIER);
        yassin.setEnabled(true);
        yassin.setLocked(false);
        Member capo = new Member("capo","ayman","657745316331","capo","good", MemberDegree.ROLE_NCOFFICER);
//        capo.setEnabled(true);
//        capo.setLocked(false);
        Member mohamed = new Member("mohamed","ayman","656645316331","mohamed","good", MemberDegree.ROLE_OFFICER);
